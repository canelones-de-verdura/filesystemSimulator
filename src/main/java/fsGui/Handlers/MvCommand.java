...
public class MvCommand extends BaseCommand {
    ...
    protected void internalHandle(String message, ArrayList<String> arguments, StringBuilder response,
        ...
        fsDir padreDestino = (fsDir) shell.fsManager
        ...
        // Si el origen es un link, se obtiene la referencia y lo trato como un archivo
        // o directorio normal.
        if (origen instanceof fsLink)
            origen = ((fsLink) origen).getReference();
        ...
        // TODO para mañana cuando me levante, hay que emprolijar esto, es una basura,
        // puro código redundante.
        // Caso DIR - FILE
        ...
        if (origen instanceof fsFile) {
            ...
            fsDir padreOrigen = (fsDir) shell.fsManager
